...
class Deck( object ):
    ...
    def __init__( self ):
        ...
        index_lst = [48, 20, 39, 49, 34, 10, 4, 42, 19, 8, 51, 15, 6, 1, 28, 0, \
                     29, 12, 21, 17, 35, 16, 44, 24, 32, 43, 7, 27, 37, 46, 36, \
                     47, 40, 2, 45, 31, 11, 30, 33, 3, 18, 41, 50, 13, 22, 26, 25,\
                     9, 23, 38, 14, 5]
        temp = self.__deck[:]
        for i in range(0,52):
            self.__deck[i] = temp[index_lst[i]]
...
#        random.shuffle(self.__deck)
    ...
    def __getitem__( self, index ):
        """ return the card in the deck that corresponds to the index. """
